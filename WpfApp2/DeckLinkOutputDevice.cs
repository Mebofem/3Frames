    ...
    public class DeckLinkOutputDevice : IDeckLinkVideoOutputCallback
    {
        ...
        public void StopPlayback()
        {
            ...
            if (state == PlaybackState.Running)
            {
                ...
                // Set the event right after calling StopScheduledPlayback
                m_stopScheduledPlaybackEvent.Set();
                // Wait for the ScheduledPlaybackHasStopped callback
            ...
            // Additional code for handling other states...
        }

        void IDeckLinkVideoOutputCallback.ScheduledPlaybackHasStopped()
        {
            MessageBox.Show("ScheduledPlaybackHasStopped event triggered.");
            m_stopScheduledPlaybackEvent.Set();
        }
